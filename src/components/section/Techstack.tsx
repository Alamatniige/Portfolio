...
export default function Techstack() {
  ...
  return (
    <section
      ref={sectionRef}
      id="techstack"
      className="relative flex flex-col items-center justify-center overflow-hidden py-12 md:py-20"
    >
      ...
      >
        <LogoLoop
          ...
          renderItem={(item, key) => (
            <div
              key={key}
              className="flex items-center justify-center h-[var(--logoloop-logoHeight)] w-[var(--logoloop-logoHeight)]"
            >
              {(item as any).src}
            </div>
          )}
