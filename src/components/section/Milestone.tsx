...
const JOURNEY: JourneyMilestone[] = [
  {
    ...
    period: "Year 1",
    description:
      "Started my IT journey with excitement and curiosity. Learned programming fundamentals, data structures, and basic computer science concepts. This foundation sparked my passion for technology.",
  ...
  },
  {
    ...
    period: "Year 2",
    description:
      "Dove deeper into software engineering principles. Worked on multiple projects, learned different programming languages, and started exploring web development and databases. Joined coding communities and participated in hackathons.",
  ...
  },
  {
    ...
    period: "Year 3",
    description:
      "Chose my specialization path and worked on more complex projects. Focused on full-stack development, system design, and best practices. Built portfolio projects and contributed to open-source initiatives.",
  ...
  },
  {
    ...
    description:
      "Applied my knowledge in real-world scenarios through internships and freelance work. Gained experience working in teams, understanding client needs, and delivering production-ready solutions.",
  ...
  },
  {
    ...
    description:
      "Continuously learning new technologies, staying updated with industry trends, and building impactful projects. Preparing for graduation and looking forward to contributing to innovative tech solutions.",
  ...
  useEffect(() => {
    ...
    milestoneItems.forEach((item, index) => {
      ...
      if (!isLast) {
        ...
        if (imageDiv) {
          // Parallax kept well under the minimum item gap (space-y-12 = 48px)
          gsap.to(imageDiv, {
            y: (isEven ? -20 : -16) * parallaxMultiplier,
            scrollTrigger: {
        ...
        if (descriptionDiv) {
          // Slightly less movement than image to create depth difference
          gsap.to(descriptionDiv, {
            y: (isEven ? -12 : -16) * parallaxMultiplier,
            scrollTrigger: {
              trigger: item as HTMLElement,
              start: "top bottom",
              end: "bottom top",
          ...
          {JOURNEY.map((milestone, index) => {
            ...
            return (
              <li
                ...
                className="relative isolate flex flex-col md:grid md:grid-cols-2 items-center gap-6 md:gap-10 lg:gap-12"
              >
                ...
                >
                  ...
                  {milestone.skills && (
                    <div
                      className={`mt-4 flex flex-wrap gap-2 justify-center ${shouldImageBeLeft ? "md:justify-end" : ""}`}
                    >
